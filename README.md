<h1 align="center">Merhaba, Ben Muhammed Tıraş 👋</h1>
...
Yazılım dünyasına henüz adım attım ve her gün yeni şeyler öğrenmeye devam ediyorum. Şu an temel kavramları sağlam atmaya, temiz ve okunabilir kod yazmaya odaklanıyorum.

- 🖥️ **Hedefim:** Masaüstü uygulama geliştirme alanında kendimi geliştirmek
- 🌱 **Şu an öğreniyorum:** C#, Python, JavaScript / HTML / CSS
- 💡 **Felsefem:** Önce anla, sonra yaz. Küçük adımlarla büyük şeyler inşa edilir.
- 🚀 **Uzun vadeli hedef:** Güçlü ve kullanışlı Windows masaüstü uygulamaları geliştirmek

---

## 🛠️ Öğrendiğim Teknolojiler

### Diller (Öğrenme Sürecinde)
<p>
...
- [ ] C# ile ilk masaüstü uygulamamı tamamlamak
- [ ] Python'da temel algoritma ve veri yapılarını öğrenmek
- [ ] JavaScript ile ilk interaktif web sayfamı yapmak
- [ ] GitHub'da düzenli commit alışkanlığı kazanmak
...
<p>
  ...
  <a href="mailto:E-POSTA@gmail.com">
